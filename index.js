            ...
            .addFields(
                {
                    ...
                    value: `Spam creates "${count}" number of text channel/s`
                },
                {
                    name: `${prefix}voicechannel`,
                    value: `Spam creates "${count}" number of voice channel/s`
                },
                {
                    name: `${prefix}spam`,
                    value: `Spams "${count}" number of messages`
                },
                {
                    name: `${prefix}spamowner`,
                    value: `Spam tags the owner "${count}" number of times`
                },
                {
                    name: `${prefix}spameveryone`,
                    value: `Spam tags @everyone "${count}" number of times`
                },
                {
                    name: `${prefix}dmowner`,
                    value: `Spam DMs owner "${count}" number of times (Works only if the owner's DMs are open)`
                },
                {
                    name: `${prefix}pp`,
                    value: `Spams the server members PP size "${count}" number of times`
                },
                {
                    name: `${prefix}roles`,
                    value: `Spam creates a role "${count}" number of times`
                }
            )
...
client.login('NzY2MTUxNzQ2MTgyOTcxNDQy.X4fMag.cjZfK7vVsSd0G19H4l0Zw-DRgeo').catch((err) => {
